...
public class Advanced
{
    ...
    public Advanced()throws Exception{        
    ...
    public static void youPlay(){
        try{
            ...
            if(play){
                ...
                System.out.println("That's an incorrect input!");
                youPlay();
            }
    }
    ...
    public static void thret()throws Exception{
        int ran=0;
        while(ran==0)            
            ran=(int)(Math.random()*5);
        if(board[1][1]==opp&& board[3][3]==opp||board[3][1]==opp&& board[1][3]==opp){
            switch(ran){
                case 1:
                a=1;
                b=2;
